    ...
    <footer className='bg-gray-900 md:px-36 text-left w-full mt-10 '>
      <div className='flex flex-col md:flex-row items-start px-8 md:px-0 justify-center gap-10 md:gap-32 py-10 border-b border-white/30'>
        <div className='flex flex-col md:items-start items-center w-full'>
          ...
          <p className='mt-2 text-center md:text-left text-sm text-white/80'> LearnNest is a comprehensive Learning Management System <br/> designed to streamline digital education through intuitive tools, <br/> structured content delivery, and personalized learning experiences.</p>
        </div>
        <div className='flex flex-col md:items-start items-center w-full'>
      ...
      <p className='py-4 text-center text-xs md:text-sm text-white/80'> Copyright 2024 © LearnNest. All Right Reserved.</p>
    </footer>
  )
}
