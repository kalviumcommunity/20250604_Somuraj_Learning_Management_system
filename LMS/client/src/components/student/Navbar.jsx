...
const Navbar = () => {
  ...
  return (
    <div className={`flex items-center justify-between h-20 md:h-15 sm:px-10 md:px-14 lg:px-32 border-b border-gray-500 ${isCourseListPage ? 'bg-white' : 'bg-cyan-100/70'}`}>
      <img onClick={()=> navigate('/')} src={assets.logo} alt="Logo" className='h-12 w-auto object-contain cursor-pointer'/>
