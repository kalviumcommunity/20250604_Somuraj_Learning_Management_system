    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p>
            Course by <span className="text-blue-600 underline">Somuraj</span>
          </p>
        ...
        <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5">
            ...
            <button className='w-80 ml-8 mt-4 py-3 rounded bg-blue-600 text-white font-medium'>
              {isAlreadyEnrolled ? 'Already Enrolled':'Enroll Now'}
            </button>
            <div className='pt-6'>
              <p className='md:text-xl ml-3  text-lg font-medium text-gray-800'>What's in the course</p>
              <ul className='ml-10 pt-2 pb-5 text-sm md:text-default list-disc text-gray-500'>
